...
Веб-тренажер для практики SQL: 125 завдань, розкладених по 8 рівнях, з бізнес-контекстом і трьома підказками. Після перевірки тренажер демонструє вердикт — правильно чи ні. У разі потреби варіант правильний із поясненням можна переглянути клікнувши кнопку «Показати відповідь».
