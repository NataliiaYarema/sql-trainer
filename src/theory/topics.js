...
const topics = [
  {
    ...
    summary:
      'Запит починається з того, що ви називаєте потрібні колонки (SELECT) і таблицю (FROM).',
    summaryBlocks: [
      [
    ...
    examples: [
      {
        ...
        `),
        result:
          'Червневі замовлення з іменем клієнта поруч. Клієнт без замовлень у червні не з’явиться жодного разу.',
      },
      {
...

  {
    ...
    summaryBlocks: [
      ...
      'Результат однаковий, читається краще, і один CTE можна використати кілька разів або ' +
        ...
        'розкладіть його на іменовані кроки.',
    ],
...

  {
    ...
    summaryBlocks: [
      'На цьому рівні ви поєднуєте все вивчене в єдину аналітичну систему:',
      [
        'WITH (CTE) — стає основою вашого коду: він розкладає складні ' +
    ...
    cases: [
      ...
      },
      {
        ...
        watchOut: [
          'Одиниця рахунку вирішує все. Порахуєте унікальних людей за ' +
          ...
          'Порядок кроків задається явно, а не алфавітом чи часом появи ' +
            'у даних. Якщо ваша воронка має інші етапи — міняється саме ' +
      ...
      },
      {
        ...
        watchOut: [
          ...
          'Обовʼязково саме LEFT JOIN. Зі звичайним обʼєднанням ' +
            ...
            'ви усередните лише покупців, а не всю когорту — LTV вийде ' +
      ...
      },
      {
        ...
        question:
          'Розділіть покупців на сегменти: VIP, Loyal, Potential, At-Risk, ' +
        ...
        watchOut: [
          ...
          'Порядок гілок CASE — це пріоритет, а не оформлення: перша ' +
            ...
            'розглядаються. Переставте рядки місцями — і сегменти ' +
            'вийдуть іншими.',
    ...
    tips: [
      {
        text:
          'Прочитайте питання двічі й назвіть метрику вголос: утримання, ' +
          'воронка, LTV чи сегментація. Половина хибних запитів — це ' +
          'правильний SQL до іншої метрики.',
      },
      {
        text:
          'Уточніть терміни на початку, а не після звіту: «активні» — це ' +
      ...
      {
        text:
          'Перевіряйте розумність результату, перш ніж нести його далі: ' +
      ...
      {
        text:
          'Документуйте припущення коментарем прямо в запиті — через ' +
          'місяць ви самі не згадаєте, чому давність рахується саме від ' +
          'цієї дати.',
        sql: dedent(`
          SELECT
      ...
      },
      {
        text:
          ...
          'утримання занижене за побудовою. Або виключайте його зі звіту, ' +
          'або підписуйте прямо на графіку.',
      },
    ],
  },
];
